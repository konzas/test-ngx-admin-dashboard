...
export class GanttChartService  {
  ...
  getPLan() {
    // return this.http.get('https://cap-prototype-mainserver.ap.ngrok.io/api/plan/all');
    return this.http.get('http://84.201.154.141/main/api/plan/all');
}

  startPLan() {
    console.log(`click1`);

    // return this.http.get('https://cap-prototype-mainserver.ap.ngrok.io/api/plan/start_planning');
    return this.http.get('http://84.201.154.141/main/api/plan/start_planning');
  }
